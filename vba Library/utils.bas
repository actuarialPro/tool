...
'  Part2: xrange, xrangeSelect, xrangeSet, xcopy, xpaste, xpasteA/F/T/V/W/L  <- meaning same as ctrl+alt+v shortcut
'  Basic Excel
'  Core range parser ¢w uses ^ v < >  and  ^^ vv << >>, e.g. A1>> simulate selected A1 then ctrl+right, A1:A9&vv simulate selected A1:A9 then ctrl+shift+down
...
Sub xlog()
    ...
    Else
        ...
        For Each cell In Selection
            If cell.Formula2R1C1 <> firstFormula Then
